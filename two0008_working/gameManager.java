 ...
 public class gameManager {
     public static String main() {
         ...
         */
         ...
         conditions cond0 = new conditions("Suffication", 75);
         conditions cond1 = new conditions("Dysentary", 15);
         conditions cond2 = new conditions("Freezing", 5);
         conditions cond3 = new conditions("Hunger", 10);


         List<conditions> conditionsList = new ArrayList<>(Arrays.asList(cond0, cond1, cond2, cond3));
         List<encounters> encounterList = new ArrayList<>(Arrays.asList(e0, e1, e2, e3, e4));
         
         // CONDITIONS
         boolean WIN_CONDITION = stats[4] >= 10000;
         ...
         while (!WIN_CONDITION || !LOSE_CONDITION) {
            ...
            // Reprecusions
            for (int ii = 0; ii < conditionsList.size(); ii++) {
                if (stats[ii] <=0) {
                    for (character npc : party) {
                        npc.health -= conditionsList.get(ii).healthModifier;
